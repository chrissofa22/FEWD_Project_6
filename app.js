const { enter, overlay, phraseUL, keyboard, heartArray } = varCombine();
let missed = 0;
const local = ['all present and correct', 'hoist with your own petard',
...
function varCombine() {
    ...
    return { enter, overlay, phraseUL, keyboard, heartArray };
}
